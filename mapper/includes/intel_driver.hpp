...
namespace intel_driver
{
	...
	uint64_t AllocContiguousMemory(uint64_t size);
	bool RemovePhysicalMemory(PLARGE_INTEGER phys_base, PLARGE_INTEGER size);
	bool FreeContiguousMemory(uint64_t base);
